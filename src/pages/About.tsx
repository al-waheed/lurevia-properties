    ...
    <div>
      <section className="border-b border-lurevia-border bg-white">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <h1 className="mt-4 max-w-4xl font-display text-5xl font-semibold leading-tight text-lurevia-text sm:text-6xl lg:text-7xl">
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold leading-tight text-lurevia-text">
              Property decisions should feel clear, not complicated.
            </h2>

            <div className="mt-6 space-y-5 text-base leading-8 text-lurevia-muted">
              <p>
                LUREVIA is a premium real estate company focused on helping people
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
        <div className="grid gap-10 md:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-lurevia-muted">
        ...
        <div className="mt-16 border-t border-lurevia-border pt-10">
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 text-sm font-semibold text-lurevia-text hover:text-lurevia-green"
          >
